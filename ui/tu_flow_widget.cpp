...
void TuFlowWidget::populateReportRows(const tu::ScenarioRunResult& result)
{
    ...
    static const ReportRow rows[] = {
        ...
        {"sensor_supply_unloaded", "1.1.4.2", "Питание датчиков: X1/X2/X3, выводы 36/37; В7 без нагрузки"},
        {"yalk_channels", "1.1.4.1", "ЯЛК: 80 адресов; аналоговые точки 0 / 3,1 / 6,2 В"},
        {"yalk_channels", "1.1.4.1", "ЯЛК: контакт разомкнут / 0 / 4 В"},
        {"yalk_initial", "1.1.4.10", "ЯЛК: обрыв 80 входов; U < 0 В"},
        {"yalk_overload", "1.1.4.11", "ЯЛК: перегрузка +/-12 В; |Δcode| ≤ 5"},
        {"yalk_reference_voltage", "1.1.4.9", "В7: эталон 6,20 +/- 0,03 В"},
        {"ytp_channels", "1.1.4.1", "ЯТП: 30 каналов; 0 / 120 / 240 Ом"},
        {"yvp_channels", "1.1.4.7", "ЯВП-8: АЧХ при Kу=1; 12 частот; 8 каналов"},
