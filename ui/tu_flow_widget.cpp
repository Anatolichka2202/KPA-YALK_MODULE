...
void TuFlowWidget::populateReportRows(const tu::ScenarioRunResult& result)
{
    ...
    static const ReportRow rows[] = {
        {"readiness", "1.4.13", "Готовность не более 30 с при 27 В"},
        {"supply_range", "1.4.3", "Питание 24 / 27 / 35 В; выдержки 19 / 37 В"},
        {"supply_range", "1.4.5", "Общий ток УБСИ не более 0,4 А"},
        {"yalk_channels", "1.4.1", "ЯЛК: 80 адресов; 0 / 3,1 / 6,2 В"},
        {"yalk_channels", "1.4.14", "ЯЛК: погрешность не более 0,5 % диапазона"},
        {"yalk_channels", "1.4.1", "ЯЛК: логика при 0 / 0,8 / 2,5 В"},
        {"yalk_initial", "1.4.10", "ЯЛК: обрыв 80 входов; U < 0 В"},
