# УБСИ UI Prototype v0.4 — сверка с реальными сценариями master
...
Prototype v0.4 визуализирует baseline как постоянную «тень» и current/last snapshot как основной столбец.
