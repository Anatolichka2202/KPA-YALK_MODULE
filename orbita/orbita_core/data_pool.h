...
public:
    ...
    int analogCount() const { return analog_.size(); }
    int contactCount() const { return contact_.size(); }
    int fastCount() const { return fast_.size(); }
    int temperatureCount() const { return temperature_.size(); }
    int busCount() const { return bus_.size(); }
