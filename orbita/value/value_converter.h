...
// Извлечение 10-битного кода (биты 1-10) – как в Delphi
uint16_t analog10bitCode(uint16_t word);
// Преобразование кода в напряжение (0-6.2 В)
double analogCodeToVoltage(uint16_t code, double scale = 6.2 / 1023.0);

// Для 9-битного канала T01-01
uint16_t analog9bitCode(uint16_t word);
double analog9bitCodeToVoltage(uint16_t code, double scale = 6.2 / 511.0);
