...
Текущий аудит платформенных возможностей и тестов — в
[трекере MilTechStation V1](miltechstation-v1-project-runtime.md#aудит-общего-слоя-станции-2026-09-25).
Здесь `DONE` означает завершение указанного технического среза, не общий
статус `CLOSED`: локальный CTest текущего `master` на 2026-09-25 даёт 21/24,
в том числе не проходит общий `stand.scenario_resource`.
