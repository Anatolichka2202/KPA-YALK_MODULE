...
Историческая заметка `operator-ui-new-dis.md` удалена из рабочей документации;
её редакции доступны в истории Git. Требования к операторскому интерфейсу
ведутся в [task/ubsi/operator.md](task/ubsi/operator.md).
