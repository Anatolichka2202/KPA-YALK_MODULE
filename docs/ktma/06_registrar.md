> **Исторический документ; scope и порядок реализации заменены 08.09.2026.** Текущая [поставка 2.0](../../_plans/ubsi-minimal-delivery-2.0.md), [реестр закрытия](../../_plans/README.md). Подтверждённые технические факты сохраняются.
